...
var _customerDetails = _interopRequireDefault(__webpack_require__(/*! ./pages/qing-f-c/sellDupty/customer-details.vue */ 471));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _customer_details_vue_vue_type_template_id_73f20ffc___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./customer-details.vue?vue&type=template&id=73f20ffc& */ 472);
/* harmony import */ var _customer_details_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./customer-details.vue?vue&type=script&lang=js& */ 474);
...
/* harmony import */ var _customer_details_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./customer-details.vue?vue&type=style&index=0&lang=scss& */ 476);
...
{}), _defineProperty(_components$data$onPu, "methods",
{
  ...
  getLinkMan: function getLinkMan() {var _this3 = this;
    ...
    JsyServer.linkMan(_data).then(function (res) {
      ...
      _this3.totalCount = res.data.data.totalCount;
      console.log('联系人数量==', _this3.totalCount);
    }).catch(function (err) {
      console.log("Err===", err);
    });
  },
  ...
  toProductPage: function toProductPage() {
    ...
    var url = "/pages/qing-f-c/productShow/mainShow?companyCode=" + _companyCode;
