	...
	<view>
		...
		<view class="box-shawn" style="margin-top: 20upx;">
			...
			<view class="content-1">
				...
				<view class='items'>
					<myPickerPart :items="selectList.qualityList" @mychange="pickerChange('quality',$event)" :firstLabel='-1'></myPickerPart>
				</view>
			</view>
			<view class="content-1">
		...
		<view class="box-shawn" style="margin-top:20upx;">
			<view class="content-1">
				...
				<view class='items'>
					<myPickerPart :items="selectList.orderAddrList" @mychange="pickerChange('orderAddr',$event)" :firstLabel='-1'></myPickerPart>
				</view>
			</view>
			<view class="content-1">
				<view class='label'>资金状况</view>
				<view class='items'>
					<myPickerPart :items="selectList.capitalPositionList" @mychange="pickerChange('capitalPosition',$event)" :firstLabel='-1'></myPickerPart>
				</view>
			</view>
			<view class="content-1">
				<view class='label'>供应链状况</view>
				<view class='items'>
					<myPickerPart :items="selectList.supplyChainList" @mychange="pickerChange('supplyChain',$event)" :firstLabel='-1'></myPickerPart>
				</view>
			</view>
			<view class="content-1">
				<view class='label'>接单概率</view>
				<view class='items'>
					<myPickerPart :items="selectList.orderProbabilityList" @mychange="pickerChange('orderProbability',$event)" :firstLabel='-1'></myPickerPart>
				</view>
			</view>
	...
	export default {
		...
		methods:{
			...
			async submit(){
				...
				uni.redirectTo({
					url: `./detail?recordCode=${res.data.data.msg}`
				})
