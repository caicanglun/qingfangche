<template>
	<view>
		...
		<view>
		  <inquireList @change="toDetail" :items="customerList"></inquireList>
...
<script>
	...
	import inquireList from "@/components/inquireList-select.vue";
	...
	export default {
		...
		methods:{
			async getMoreCustomer(){
				    ...
				    const res = await this.$http.get('/latent/inquiry_list',{data:data})
					 console.log(res)
