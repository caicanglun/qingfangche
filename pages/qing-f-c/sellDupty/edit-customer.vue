		...
		<form @submit="formSubmit" report-submit="true">
		  <view class="box box_shadow">
				...
				<view class="list flex_c">
				  ...
				  <input class="input" name="factoryAddress" v-model="customerInfo.factoryAddress" placeholder="请输入"></input>
		...
		onShow:function(){
			...
			setTimeout(function() {
				console.log(_this.customerInfo)
				  ...
				  let sellRoom = _this.customerInfo.hasSalesroom
