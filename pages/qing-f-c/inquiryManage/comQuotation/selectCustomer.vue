	...
	<view>
		...
		<view>
		  <block v-for="(item, index) in customerList" :key="index">
		    <view class="list flex_c box_shadow" @click.stop="toClientDetail(item.buyOrSellCode,item.companyCode)" :data-id="item.buyOrSellCode" :data-index="index">
		      ...
		      <view :class="(compileing?'wid_610':'wid_670')">
		        ...
		        <view class="flex_c mt_20">
		          ...
		          <view class="fs_14 ">
                    ...
                    <text style="padding-left: 30upx;">{{item.companyTypeName||''}}</text>
		          </view>
		        </view>
		        <view class="flex_c mt_20">
					  ...
					  <view class="fs_14">
					  {{item.realName||''}}
					  <text style="padding-left: 30upx;">{{item.phone||''}}</text>
					  </view>
		        </view>
...
<script>
	...
	export default {
		...
		methods:{
			...
			toClientDetail:function(buyOrSellCode,companyCode){
