		...
		<view class="hand_box">
			<view class="wrap-box">
				...
				<view class="box-content">
				  <text class='title'>卖帮办：</text><text>{{topList.inquiry.deputyName ||''}}</text>
				</view>
				<view class="box-content flex_sb">
				  <veiw>
					  <text class='title'>卖家：</text><text>{{topList.inquiry.companyCode||''}}</text>
				  </veiw>
	...
	export default {
		...
		methods:{
			...
			getDeputyQuotation:function(){
				let number = _this.number.split('-')[0]
				let data={
					inquiryNumber: number,  //	询价单号
