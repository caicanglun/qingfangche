<template>
	<view>
		...
		<view class="details-box">
			<view class='wrap-box'>
				<view class="details-title" v-if="topList.goAnalysisSample&&!topList.comeAnalysisSample">
					<view>品名（别名）：{{topList.goAnalysisSample.tradeName}}</view>
					<view>原样分析数据</view>
				</view>
				 <!-- 产品要素 -->
				 
				<chanpinyaosu :inquiryInfo="topList.goAnalysisSample" v-if="topList.goAnalysisSample&&!topList.comeAnalysisSample" ></chanpinyaosu> 
				<!-- ------------------------------ -->
				
				
				<view class="details-title" v-if="topList.comeAnalysisSample">
					<view>品名（别名）：{{topList.goAnalysisSample.tradeName}}</view>
					<view>回样分析数据</view>
				</view>

				<chanpinyaosu :inquiryInfo="topList.comeAnalysisSample" v-if="topList.comeAnalysisSample" ></chanpinyaosu> 	   
		...
		<view  class="productPart" v-if="!isDisplayOrginal"> 
		        <view class='wrap-box'>
						<view class="details-title-orginal" v-if="topList.hasGoInitialSample&&!topList.hasComeInitialSample">
							<view>原样初始数据</view>
						</view>
						<chanpinyaosu :inquiryInfo="topList.goInitialSample" v-if="topList.hasGoInitialSample&&!topList.hasComeInitialSample"></chanpinyaosu>
						
						
						<view class="details-title-orginal" v-if="topList.hasComeInitialSample">
							<view>回样初始数据</view>
						</view>
						<chanpinyaosu :inquiryInfo="topList.comeInitialSample" v-if="topList.hasComeInitialSample"></chanpinyaosu>
		...
		<view class="fixed_bottom box_shadow_btn" v-if="topList.hasComeAnalysisSample">
		  ...
		  <button class="btn_all" @tap="setCompareResult" hover-class="none">设置分析结果</button>
		</view>
