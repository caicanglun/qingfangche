			...
			<view class="content">
				...
				<view class="content-right">
					<view class="content-text">
						...
						<view>
							<rangeButton :initValue='compareResult.ingredient' @buttonChange="compareChange('ingredient',$event)" :items="items" ></rangeButton>
						</view>
					</view>
					<view></view>
				</view>
			...
			<view class="content">
				...
				<view class="content-right">
					<view class="content-text-1">
						...
						<view>
							<rangeButton :initValue='compareResult.specification' @buttonChange="compareChange('specification',$event)" :items="items"></rangeButton>
						</view>
					</view>
					<view></view>
				</view>
			...
			<view class="content">
				...
				<view class="content-right">
					<view class="content-text">
						...
						<view>
							<rangeButton :initValue='compareResult.style' @buttonChange="compareChange('style',$event)" :items="items"></rangeButton>
						</view>
					</view>
					<view></view>
				</view>
			...
			<view class="content">
				...
				<view class="content-right">
					<view class="content-text">
						...
						<view>
							<rangeButton :initValue='compareResult.clothType' @buttonChange="compareChange('clothType',$event)" :items="bigButtons" wid="wid_240"></rangeButton>
						</view>
					</view>
					<view></view>
				</view>
			...
			<view class="content">
				...
				<view class="content-right">
					<view class="content-text">
						...
						<view>
							<rangeButton :initValue='compareResult.density' @buttonChange="compareChange('density',$event)" :items="items"></rangeButton>
						</view>
					</view>
					<view></view>
				</view>
			...
			<view class="content">
				...
				<view class="content-right">
					<view class="content-text">
						...
						<view>
							<rangeButton :initValue='compareResult.gramWeight' @buttonChange="compareChange('gramWeight',$event)" :items="items"></rangeButton>
						</view>
					</view>
					<view></view>
				</view>
			...
			<view class="content">
				...
				<view class="content-right">
					<view class="content-text">
						...
						<view>
							<rangeButton :initValue='compareResult.clothBreadth' @buttonChange="compareChange('clothBreadth',$event)" :items="items"></rangeButton>
						</view>
					</view>
					<view></view>
				</view>
...
<script>
	import rangeButton from "@/components/rangeButton-edit.vue";
	let _this
	export default {
		components:{
			rangeButton
		...
		methods:{
			...
			confirm:function(){
				let url = this.Api.contrastUpdate
				let data = _this.form
				console.log(data)
				uni.showLoading({
					title:"加载中",
