<template>
	<view>
		...
		<view v-if="topList.hasQuotationDirector" class="details-box" >
			<view class='wrap-box' style="padding-left: 20upx; padding-top: 20upx;">
	
				<view>
					<view class='baojiaTitle'>销售总监报价信息</view>
					<view class="content-box">
						<view class='subItem'><text class="label">报价：</text>
						<text class="color_FF6000" style="font-weight: bold;">{{salerDirect.directorUnitPrice||''}}{{topList.quotation.priceUnitName}}</text></view>
