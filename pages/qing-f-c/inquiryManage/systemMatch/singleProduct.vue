<template>
	<view class="qiun-columns">
		...
		<view class="charts-title-wrap" >
			<view class="charts-title">单品价格趋势图</view>
		...
		<block v-for="(item,index) in quotationInfo.goodsList" :key="index">
			<view class="baojia-box" @tap="toQuotateDetail(item.quotationNumber)">
				<view class="wrap-box">
					<view class='box-row'>
						<view class="title">
...
<script>
	...
	export default {
		...
		methods: {
			...
			toQuotateDetail:function(quotationNumber){
				uni.navigateTo({
