...
<view class="hand_box box_shadow margin-top-200">
  <view class="flex_sb">
    ...
    <view style="width: 100upx;display: flex;justify-content: flex-end;" @tap="delCustomer(customerInfo.companyCode)">
		<image src="/static/images/qingfc/del@2x.png" style="width: 36upx;height: 36upx;" mode="aspectFit"></image>
	</view>
		...
		uni.showModal({
		    ...
		    async success (res) {
		        if (res.confirm) {
		            ...
		            let data={companyCode: e}
		            await _this.$http.get('/cm/del',{data:data})
		            uni.hideLoading()
		            uni.navigateBack({
		            	delta: -1
		            })
