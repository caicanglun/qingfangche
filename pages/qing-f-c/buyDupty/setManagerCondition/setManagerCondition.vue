	...
	<view>
		<form @submit="sumbit">
				<view class="box box_shadow">
				  ...
				  <myPicker @mychange="operateWomChange" :items="operateWom" name="市场口碑"></myPicker>
				  <myPicker @mychange="operateCreditChange" :items="operateCredit" name="公信度级别"></myPicker>
				  <myPicker @mychange="operateOperationChange" :items="operateOperation" name="运营状况"></myPicker>
				</view> 
