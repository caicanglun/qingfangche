			...
			<view class="blockWrap">
				<view class="flex_c" style="height: 84upx;border-bottom: 1upx solid #ECECEC;justify-content: space-between;">
					...
					<view  class="flex_c_c">
						...
						<view @tap='tapSelectDay(0,$event)' :style="{color: label.label0 ==1?'#ff6000':''}"  data-index='1' style="padding-left: 10upx;">
							本月
						</view>
			...
			<view class="blockWrap">
				...
				<view style="padding: 10upx 30upx;">
					...
					<view class="flex">
						...
						<view >
							<view>
								<text @tap="toSetTargetMoney" style="color: #ff6000;padding-right: 10upx;">设置</text>
								<text @tap="toSelctList">
				...
				<view style="padding: 10upx 30upx;">
					...
					<view class="flex">
						...
						<view @tap="toSelectTargetCustomer"> 
							{{content1.targetCount||0}}
						</view>
		...
		<view class="box-shawn" style="margin-top: 20upx;padding-bottom: 30upx;" id="tabbar2">
			<view class="blockWrap">
				...
				<view style="padding: 0 30upx;margin-top: 30upx;">	
					...
					<view class="flex_sb" style="margin-top: 20upx;" v-if="postCode=='BUY_DEPUTY'">
						<view>
					...
					<view class="flex_sb" style="margin-top: 20upx;" v-if="postCode=='SELL_DEPUTY'">
						<view>
	...
	export default {
		...
		methods:{
			...
			async getRegionCode(){
				...
				tmp.forEach((item)=>{
					this.regionCodeList0.push({label:item.label,id:item.id})
					this.regionCodeList1.push({label:item.label,id:item.id})
					this.regionCodeList2.push({label:item.label,id:item.id,buyOrSell: item.buyOrSell})
					this.regionCodeList3.push({label:item.label,id:item.id})
					this.regionCodeList4.push({label:item.label,id:item.id})
					this.regionCodeList5.push({label:item.label,id:item.id})
					this.regionCodeList6.push({label:item.label,id:item.id})
				...
				this.regionCodeList3.unshift({label:'全部',id: 0})
				this.regionCodeList4.unshift({label:'全部',id: 0})
				this.regionCodeList5.unshift({label:'全部',id: 0})
				this.regionCodeList6.unshift({label:'全部',id: 0})
