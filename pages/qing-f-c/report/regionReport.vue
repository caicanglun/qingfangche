			...
			<view class="blockWrap">
				...
				<view class="flex_sb" style="align-items: center;margin-left: -30upx;">
					<view style="background: #FFFFFF;height: 60upx;">
						<!-- <ms-dropdown-menu>
						    ...
						    <ms-dropdown-item v-model="userPostCode1" :list="userPostList1" @input="filterInput(1)" v-if="userPostList1.length>0"></ms-dropdown-item>
                            <ms-dropdown-item v-model="regionCode1" :list="regionCodeList1" @input="filterInput(1)" v-if="regionCodeList1.length>0"></ms-dropdown-item>
						</ms-dropdown-menu> -->
					</view>
				...
				<view style="padding: 10upx 30upx;">
					...
					<view :style="{width: comPercentWidth + '%'}" style="display: flex;justify-content: flex-end;padding: 10upx 0;">
						<view class="progressPercent">{{comPercent}}%</view>
					</view>
					...
					<view class="flex">
						...
						<view style="flex-grow: 1;">
							<view :style="{width: comPercentWidth + '%'}" style="display: flex;justify-content: flex-end;">{{content1.turnover}}万元</view>
						</view>
						<view>
							{{content1.targetMoney}}万元
						</view>
				...
				<view style="padding: 10upx 30upx;">
					...
					<view class="flex">
						...
						<view style="flex-grow: 1;">
							<view :style="{width: comPercentCountWidth + '%'}" style="display: flex;justify-content: flex-end;">{{content1.companyCount}}人</view>
						</view>
						<view>
							{{content1.targetCount}}人
						</view>
				...
				<scroll-view scroll-x class="uni-swiper-tab">
					<view class="flex" style="margin-top:20upx;">
						<view class="tabItem2"
							...
							:key= "index" 
							:class= "activeIndex2==index?'active2':''"
							 @tap= "tabSwitch2(index)"
							:data-index='activeIndex2'>
							<text>{{item}}</text>
						</view>
					</view>
				</scroll-view>
				<view v-if="items2.length>0" class="flex" style="background: #3999F4;color: #FFFFFF;border-radius: 10upx;margin-top: 20upx;">
					<view style="width:33%;line-height: 30px;">
						<view class="flex_c_c ">总金额</view>
						<view class="flex_c_c"><text class="numberFont">{{content2Detail.totalMoney||0}}</text><text class="spanFont">元</text></view>
						<view class="flex_c_c">计划回款</view> 
						<view class="flex_c_c"><text class="numberFont">{{content2Detail.planMoney||0}}</text><text class="spanFont">元</text></view>
						
					</view>
					<view style="width:33%;line-height: 30px;">
						<view class="flex_c_c">订单笔数</view>
						<view class="flex_c_c"><text class="numberFont">{{content2Detail.orderCount||0}}</text><text class="spanFont">笔</text></view>
						<view class="flex_c_c">实际回款</view> 
						<view class="flex_c_c"><text class="numberFont">{{content2Detail.realMoney||0}}</text><text class="spanFont">元</text></view>
						
					</view>
					<view style="width:33%;line-height: 30px;">
						<view class="flex_c_c">交易总数量</view>
						<view class="flex_c_c"><text class="numberFont">{{content2Detail.meterNumber||0}}</text><text class="spanFont">米</text></view>
						<view class="flex_c_c">金融逾期</view> 
			...
			<view class="blockWrap">
				...
				<view class="flex">
				 ...
				 <view class="flex_c" style="height: 50upx;" v-if="content3.list.length > 0">
					 <view style="font-size: 12px;color: #999999;">次数</view>
					 <view style="width: 600upx;font-size:12px;color: #707070;padding-left:45upx;" class="flex_sb">
						 <view>0</view>
						 <view>100</view>
						 <view>200</view>
						 <view>300</view>
				 ...
				 <view class="flex_sb" v-if="content3.list.length > 0">
					 <view class="flex_c">
						 ...
						 <view style="padding-left: 10upx;font-size: 13px;color: #333333">A级客户</view>
					 </view>
					 <view class="flex_c">
						 <view style="height:12upx;width: 12upx;background: #3293F4;"></view>
						 <view style="padding-left: 10upx;font-size: 13px;color: #333333">B级客户</view>
					 </view>
					 <view class="flex_c">
						 <view style="height:12upx;width: 12upx;background: #F89D10;"></view>
						 <view style="padding-left: 10upx;font-size: 13px;color: #333333">C级客户</view>
					 </view>
					 <view class="flex_c">
						 <view style="height:12upx;width: 12upx;background: #B350E7;"></view>
						 <view style="padding-left: 10upx;font-size: 13px;color: #333333">D级客户</view>
					 </view>
					 <view class="flex_c">
						 <view style="height:12upx;width: 12upx;background: #DADADA;"></view>
						 <view style="padding-left: 10upx;font-size: 13px;color: #333333">E级客户</view>
					 </view>
				 </view>
	    	...
	    	<view class="blockWrap">
	    		...
	    		<view style="margin-top: 20upx;">
	    			<t-table @change="change">
	    			    ...
	    			    <t-tr v-for="item in content4.list" :key="item.id">
	    			        <t-td>{{ item.realName }}</t-td>
	    			        <t-td>{{ item.following }}</t-td>
	    			        <t-td>{{ item.success }}</t-td>
	    			        <t-td>{{ item.failed }}</t-td>
	    			        <t-td>{{ item.failedProbability }}%</t-td>
	    			    </t-tr>
	    			</t-table>
	    		</view>
	    	</view>
	    	...
	    	<view class="blockWrap">
	    		...
	    		<view style="margin-top: 20upx;">
	    			<t-table @change="change">
	    			    ...
	    			    <t-tr v-for="item in content5.list" :key="item.id">
	    			        <t-td>{{ item.realName}}</t-td>
