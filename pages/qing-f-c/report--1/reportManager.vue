			...
			<view class="blockWrap">
				...
				<view class="flex">
					<view style="width:50%;line-height: 30px;">
						...
						<view class="flex_c_c"><text class="numberFont">{{content3.companyCount || ''}}</text><text class="spanFont">家</text></view>
					</view>
					<view style="width:50%;line-height: 30px;">
						<view class="flex_c_c labelTitle">跟进次数</view>
						<view class="flex_c_c"><text class="numberFont">{{content3.followCount || ''}}</text><text class="spanFont">次</text></view>
					</view>
				</view>
