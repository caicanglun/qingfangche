<template>
	<view>
		<view style="display: flex;background: #FFFFFF;margin: 30upx 15upx;padding: 24upx;border-radius: 8upx;">
			<view style="width:500upx;">
				...
				<view class="flex_c" style="height: 50upx;">
					...
					<text style="color:#8d8d8d;font-size:13px;">卖帮办：</text><text>{{goodsDetail.sellDeputyName||''}}</text>
				</view>
				<view class="flex_c" style="height: 50upx;">
		...
		<view class="fixed_bottom box_shadow_btn">
		  <button class="btn_left" hover-class="none" @tap="bindCancel">通过并上架</button>
