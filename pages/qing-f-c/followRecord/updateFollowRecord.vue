	...
	<view>
		...
		<view class="box-shawn" style="margin-top:20upx;">
			...
			<view style="width:100%; padding-bottom: 20upx;font-size:15px;">
				<textarea auto-height placeholder-style="font-size:13px" style="width: 100%;" maxlength="-1" v-model="form.remarks" @blur="bindTextAreaBlur"  placeholder="请填写"/> 
			</view>
		</view>
		<view class="box-shawn" style="margin-top:20upx;">
			...
			<view style="width:100%; padding-bottom: 20upx;font-size:15px;" >
				<textarea auto-height placeholder-style="font-size:13px" style="width: 100%;" maxlength="-1" v-model="form.nextRemarks" @blur="bindTextAreaBlur"  placeholder="请填写"/> 
			</view>
		</view>
