<template>
	<view :class="disabled ? 'uni-list-item--disabled' : ''" :hover-class="disabled || showSwitch ? '' : 'uni-list-item--hover'" class="uni-list-item" @click="onClick">
		<uni-swipe-action :options="options2" @click="swClick" :disabled="!isHaveRight">
			<view class="uni-list-item__container">
				<view v-if="thumb" class="uni-list-item__icon" :style="goodsStatus!=2?'background:rgba(0,0,0,0.6);':''">
					<image :src="thumb" class="uni-list-item__icon-img" />
					<view v-if="goodsStatus==1" style="position: absolute;top:30upx;left:15upx;z-index: 999;color:#FFFFFF;font-size:13px;">待审核</view>
					<view v-if="goodsStatus==3" style="position: absolute;top:30upx;left:15upx;z-index: 999;color:#FFFFFF;font-size:13px;">已下架</view>
