		...
		<view  class="uni-banner" style="font-size: 14px;" v-if="bannerShow">
			<view style="padding: 20upx;">
				<view style="border-bottom: 1upx solid #f2f2f2;height: 90upx;" class="flex_sb_c">
					<view class="flex_c">
						<text>报价金额</text>
						<input v-model="form.count" placeholder="请填写" type="number" style="margin-left: 20upx;width: 150upx;"/>
						<text>元/米</text>
					</view>
					
					<view>
						<text style="padding-right: 5upx;">佣金比例</text>
						<uniIcon type="help-filled" size="22" color="#999999" @tap="showTips = !showTips"></uniIcon>
					</view>
					<view>
						<text style="padding-right: 10upx;">1%</text>
					</view>
				...
				<!-- <view class="flex_sb_c" style="border-bottom: 1upx solid #f2f2f2;height: 90upx;">
					...
					<view>
						 <uniIcon type="arrowright" size="22" color="#999999"></uniIcon>
					</view>
				</view> -->
				<view class="flex_c" style="border-bottom: 1upx solid #f2f2f2;height: 90upx;">
					<text>最终报价：</text><text>3.24</text><text style="padding-left: 10upx;">元/米</text>
				</view>
			...
			<view class="flex_c_c" style="position: absolute;bottom: 0;">
				<view @tap="confirmBanner" class="flex_c_c" style="width: 750upx;color: #FFFFFF;background: #FF6000;font-size: 16px;height: 88upx;">确定</view>
			</view>
		</view>
