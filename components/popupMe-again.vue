	...
	<view>
		...
		<view  class="uni-banner"  v-if="bannerShow">
			...
			<view class="input-wrap">
				<input v-model="content" type="number" placeholder="请输入报价" placeholder-style="color: #b3b3b3;font-size: 13px;" class="input-class"/>
			</view>
			<view class="input-wrap" style="margin-top:20upx;">
				<input v-model="remarks" placeholder="请输入备注" placeholder-style="color: #b3b3b3;font-size: 13px;" class="input-class"/>
			</view>
			<!-- <view style="uni-list">
